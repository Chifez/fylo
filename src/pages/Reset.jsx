...
const Reset = ({setEmail,email}) => {
  return (
    <div className='bg-darkbg h-screen flex justify-center items-center'>
        ...
        <button className='border-2 font-semibold border-transparent px-10 text-white rounded-full bg-btn hover:bg-blue-600 hover:text-black' >reset password</button>
        </div>
    </div>
  )
}
