  ...
  return (
      ...
      <form onSubmit={(e)=>e.preventDefault()} >
        <div className='flex flex-col'>
          <input className='my-5 px-3' type="text" placeholder='email' value={email} onChange={(e)=>setEmail(e.target.value)}/>
          <input className='my-5 px-3' type="password" placeholder='password' value={password} onChange={(e)=>setPassword(e.target.value)}/>
        </div>
